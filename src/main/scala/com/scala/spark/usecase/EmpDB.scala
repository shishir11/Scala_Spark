...
class EmpDB {
  def populateList(): List[Employee]={
    val list = List[Employee](new Employee("Peter","IT",1000,"Bangalore","Karnataka","India",1,"1134456790","SE","Desktop"),
                    ...
                    new Employee("Pepper","HR",3000,"Bangalore","Karnataka","US",4,"1236456790","HRE","Desktop"),
                    new Employee("John","IT",5000,"Pune","Maharastra","India",5,null,"SSE","Desktop"),
                    new Employee("Jack","IT",4000,"Chennai","TamilNadu","UK",6,"9178456790","SSE","Desktop"),
                    new Employee("Steve","IT",8000,"Mumbai","Maharastra","US",7,"1244456790","SSE","Desktop"),
                    ...
                    new Employee("Tony","IT",75200,"Bangalore","Karnataka","US",10,"913477790","Lead","Laptop"),
                    ...
                    new Employee("Avik abcsS","Finance",1100,"Pune","Maharastra","US",13,"1236456790","Fok","Desktop"),
                    new Employee("Finance2","Finance",1200,"Bangalore","Karnataka","India",14,"1236456790","F","Desktop"),
                    new Employee("Finance3","Finance",1500,"Chennai","TamilNadu","UK",15,"1236456790","F","Desktop")   
            )
    list
  }
}